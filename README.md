...
```text
Daily: Make a $5 or greater swap on any domain token
-> ????? 8, ????? domain token, Target volume = 5.

Weekly: List any domain on the marketplace
-> ????? 9.

Weekly: Trade $100 in total volume this week
-> ????? 7, Target volume = 100.

Weekly: Trade $250 in total volume this week
-> ????? 7, Target volume = 250.
```

????? `8) Domain quest volume` ??????? ????? ?? ????????? 6 ???? ? ???????? ??????????? ????? ?? ????. ??? ???? `25` ???????????? ?????????? ????? `27.5`, ????? ????? ???????? ? ??????????? Doma ?? ?????????? ?????? `25`.

???? ?? ????????????????:

```text
Season: Add at least $10 / $50 in liquidity to a domain token
Season: Bridge a domain from Doma to Base
Season: Mint 5 domain NFTs
Season: Stake 3 subdomains
```

??? ?????? ??????? ????????? ?????????? ??????????/SDK: Uniswap V3 mint/increase liquidity, bridge ?????? domain NFT, registrar mint flow ? staking subdomains.
