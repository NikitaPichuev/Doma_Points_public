...
def get_menu_choice() -> str:
    ...
    print("7) Набить объем 250+ ETH <-> USDC.E")
    print("8) Набить объем для задания токена домена")
    print("9) Выставить невыставленные домены на продажу")
    print("10) Отменить активные листинги доменов")
    print("11) Купить дешевые токены и создать субдомены")
    print("12) Выполнить сезонное задание: перенести домен Doma -> Base")
    ...
    print("17) Выполнить дейлик: свапнуть топовые .com токены")
